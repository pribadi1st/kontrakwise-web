...
export default function RegisterForm() {
  const formSchema = zod.object({
    ...
    cPassword: zod.string().min(8),
    tnc: zod.boolean().refine(val => val === true, {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      <Field>
        ...
        />
        {errors.email && <FieldError className='text-danger'>{errors.email.message}</FieldError>}
      </Field>
      ...
      <Field>
        ...
        <Input
          ...
          className="bg-neutral-bg border-0 focus:bg-white focus:ring-2 focus:ring-primary shadow-sm"
        />
        {errors.password && <FieldError className='text-danger'>{errors.password.message}</FieldError>}
      </Field>
      ...
      <Field>
        ...
        <Input
          ...
          className="bg-neutral-bg border-0 focus:bg-white focus:ring-2 focus:ring-primary shadow-sm"
        />
        {errors.cPassword && <FieldError className='text-danger'>{errors.cPassword.message}</FieldError>}
      </Field>
      ...
      <Field>
        ...
        {errors.tnc && <FieldError className='text-danger'>{errors.tnc.message}</FieldError>}
      </Field>
      ...
      <div className="grid grid-cols-2 gap-4">
        <Button variant="outline" className="bg-neutral-bg border-0 hover:bg-white hover:shadow-sm">
