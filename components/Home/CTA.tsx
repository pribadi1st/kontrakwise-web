  ...
  return (
    <section className="py-24">
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <p className="text-xl text-slate-600 dark:text-slate-400 mb-10">Join forward-thinking contract teams and experience the future of AI-driven contract intelligence.</p>
